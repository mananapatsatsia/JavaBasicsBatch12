...
public class Task1 {
	 ...
	 * project and accessible by class name. Create a method that will accept a
	 * String as a parameter and return a new String that consist only of
	 * vowels. Method should be available inside the class only where it was
